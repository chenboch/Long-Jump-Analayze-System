...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toe_land_frame = QtWidgets.QSpinBox(self.speed_groupbox)
        self.toe_land_frame.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.toe_land_frame.setMaximum(1000)
        self.toe_land_frame.setObjectName("toe_land_frame")
        self.horizontalLayout_11.addWidget(self.toe_land_frame)
        ...
        self.toe_off_frame = QtWidgets.QSpinBox(self.speed_groupbox)
        self.toe_off_frame.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.toe_off_frame.setMaximum(10000)
        self.toe_off_frame.setObjectName("toe_off_frame")
        self.horizontalLayout_11.addWidget(self.toe_off_frame)
