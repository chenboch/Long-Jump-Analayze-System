...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Adjust_Group_Box.setMinimumSize(QtCore.QSize(450, 625))
        self.Adjust_Group_Box.setMaximumSize(QtCore.QSize(450, 16777215))
        ...
        self.label = QtWidgets.QLabel(self.Adjust_Group_Box)
        self.label.setObjectName("label")
        self.horizontalLayout_3.addWidget(self.label)
        self.frame_number_selector = QtWidgets.QSpinBox(self.Adjust_Group_Box)
        self.frame_number_selector.setMaximum(1000)
        self.frame_number_selector.setProperty("value", 60)
        self.frame_number_selector.setObjectName("frame_number_selector")
        self.horizontalLayout_3.addWidget(self.frame_number_selector)
        self.frame_number_confirm_btn = QtWidgets.QPushButton(self.Adjust_Group_Box)
        self.frame_number_confirm_btn.setObjectName("frame_number_confirm_btn")
        self.horizontalLayout_3.addWidget(self.frame_number_confirm_btn)
        self.label_2 = QtWidgets.QLabel(self.Adjust_Group_Box)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.length_selector = QtWidgets.QSpinBox(self.Adjust_Group_Box)
        self.length_selector.setObjectName("length_selector")
        self.horizontalLayout_3.addWidget(self.length_selector)
        self.set_length_btn = QtWidgets.QPushButton(self.Adjust_Group_Box)
        self.set_length_btn.setObjectName("set_length_btn")
        self.horizontalLayout_3.addWidget(self.set_length_btn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.frame_number_confirm_btn.setText(_translate("MainWindow", "確認"))
        self.label_2.setText(_translate("MainWindow", "Length(m): "))
