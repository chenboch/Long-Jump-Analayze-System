...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.show_length_information_checkBox = QtWidgets.QCheckBox(self.stride_groupbox)
        self.show_length_information_checkBox.setChecked(True)
        self.show_length_information_checkBox.setObjectName("show_length_information_checkBox")
        self.verticalLayout_3.addWidget(self.show_length_information_checkBox)
        ...
        self.show_speed_information_checkBox = QtWidgets.QCheckBox(self.speed_groupbox)
        self.show_speed_information_checkBox.setChecked(True)
        self.show_speed_information_checkBox.setObjectName("show_speed_information_checkBox")
        self.verticalLayout_5.addWidget(self.show_speed_information_checkBox)
        ...
        self.jump_frame_start = QtWidgets.QSpinBox(self.speed_groupbox)
        self.jump_frame_start.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.jump_frame_start.setMaximum(1000)
        self.jump_frame_start.setObjectName("jump_frame_start")
        self.horizontalLayout_11.addWidget(self.jump_frame_start)
        ...
        self.jump_frame_end = QtWidgets.QSpinBox(self.speed_groupbox)
        self.jump_frame_end.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.jump_frame_end.setMaximum(10000)
        self.jump_frame_end.setObjectName("jump_frame_end")
        self.horizontalLayout_11.addWidget(self.jump_frame_end)
        self.display_speed_btn = QtWidgets.QPushButton(self.speed_groupbox)
        self.display_speed_btn.setMinimumSize(QtCore.QSize(100, 0))
        self.display_speed_btn.setMaximumSize(QtCore.QSize(120, 16777215))
        self.display_speed_btn.setObjectName("display_speed_btn")
        self.horizontalLayout_11.addWidget(self.display_speed_btn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.show_length_information_checkBox.setText(_translate("MainWindow", "顯示長度資訊"))
        self.butt_width_label.setText(_translate("MainWindow", "髖與腳跟的長度 (cm):"))
        ...
        self.show_speed_information_checkBox.setText(_translate("MainWindow", "顯示速度資訊"))
        ...
        self.label.setText(_translate("MainWindow", "起跳範圍(frame): "))
        self.label_2.setText(_translate("MainWindow", "~"))
        self.display_speed_btn.setText(_translate("MainWindow", "顯示速度"))
